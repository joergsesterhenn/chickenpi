 ...
 *                       only.
 *
 * Configurion author  : Jörg Sesterhenn
 * Configurion date    : 20.07.2025
 * Configurion version : 1
 *
 * ***************************************************************
 * 
 * Intended use:
...
// [ [     x,      y], touch-wall  , bottom, top ],
   [ [ 28.00,  18.00], NORTH + EAST, true  , true],
   [ [-28.00,  18.00], NORTH + WEST, true  , true],
   [ [ 28.00, -18.00], SOUTH + EAST, true  , true],
   [ [-28.00, -18.00], SOUTH + WEST, true  , true]
];
...
module components_negative() {
    rotate(90) {
        ...
        translate([-22,0,4]) {
            rotate([90,0,90]){cylinder(h=4,r=2);}
        }
        translate([-22,5,4]) {
            rotate([90,0,90]){cylinder(h=4,r=2);}
        }
